"""
File Service - FastAPI Application Factory
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting File Service", extra={
...
def create_application() -> FastAPI:
    ...
    app.include_router(upload_router, prefix="", tags=["File Upload"])
